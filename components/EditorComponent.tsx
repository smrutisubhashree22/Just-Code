  ...
  return (
    <div className="min-h-screen dark:bg-slate-900 rounded-2x1 shadow-2x1 py-6 px-8">
      ...
      <div className="flex items-center justify-between pb-3">
        <h2 className="scroll-m-20 text-3xl font-semibold tracking-tight first:mt-0">🍜 Just Code ♨️</h2>
        ...
        >
          ...
          <ResizablePanel defaultSize={50} minSize={35}>
             <Editor
              ...
              language={languageOption.language}
               options={{
                fontSize: 16, // Increase font size here (default is 14)
                fontFamily: 'Consolas, "Courier New", monospace', // Optional: customize font family
                lineHeight: 24, // Optional: adjust line height for better readability
                minimap: { enabled: false }, // Optional: disable minimap for more space
              ...
              <div className="px-6 space-y-2 divide-y-2 divide-slate-50">
                 {err ? (
                  <div className="flex items-center space-x-2 text-red-500 border border-red-600 px-6 py-6">
                    ...
                    <p className="text-xs">
                     Oops!! Failed to Compile the Code , Please try again !
                    </p>
                  </div>
                ) : (
                  <>
